...
class ChainstateWriteCrashTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # long-running test
        issue_args = "-issueprices=22000,22000,22000,22000,22000,22000,22000"
        self.base_args = ["-limitdescendantsize=0", "-maxmempool=0", "-rpcservertimeout=900", "-dbbatchsize=200000", issue_args]
        ...
        self.node3_args = ["-blockmaxweight=4000000", issue_args]
