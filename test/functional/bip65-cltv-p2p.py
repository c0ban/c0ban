...
class BIP65Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        block = create_block(int(tip, 16), create_coinbase(CLTV_HEIGHT - 1), block_time, CLTV_HEIGHT - 1)
        block.nVersion = 3
        ...
        tip = block.sha256
        block_time += 1
        block = create_block(tip, create_coinbase(CLTV_HEIGHT), block_time, CLTV_HEIGHT)
        block.nVersion = 3
        block.solve()
        node0.send_and_ping(msg_block(block))
