...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(walletinfo['immature_balance'], 22000)
        ...
        assert_equal(txout['value'], 22000)
        ...
        assert_equal(self.nodes[0].getbalance(), 44000 - 21)
        ...
        assert_equal(self.nodes[2].getbalance(), 43994)
        ...
        node_2_bal = self.check_fee_amount(self.nodes[2].getbalance(), Decimal('43984'), fee_per_byte, self.get_vsize(self.nodes[2].gettransaction(txid)['hex']))
        ...
        usp = self.nodes[1].listunspent(query_options={'minimumAmount': '21999.998'})[0]
        inputs = [{"txid": usp['txid'], "vout": usp['vout']}]
        outputs = {self.nodes[1].getnewaddress(): 21999.998, self.nodes[0].getnewaddress(): 11.11}
        ...
        assert_raises_rpc_error(-5, "Invalid c0ban address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Bitcoin address
        assert_raises_rpc_error(-5, "Invalid c0ban address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid c0ban address or script", self.nodes[0].importaddress, "invalid")
