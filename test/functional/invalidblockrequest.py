...
class InvalidBlockRequestTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # b'0x51' is OP_TRUE
        tx1 = create_transaction(self.block1.vtx[0], 0, b'\x51', 22000 * COIN)
        tx2 = create_transaction(tx1, 0, b'\x51', 22000 * COIN)
        ...
        self.block_time += 1
        block3.vtx[0].vout[0].nValue = 100 * 221 * COIN # Too high!
