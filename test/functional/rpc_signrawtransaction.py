...
class SignRawTransactionsTest(BitcoinTestFramework):
    ...
    def witness_script_test(self):
        ...
        self.nodes[0].sendtoaddress(p2sh_p2wsh_address["address"], 21999.999)
        ...
        spending_tx = self.nodes[0].createrawtransaction([unspent_output], {self.nodes[1].getnewaddress(): Decimal("21999.998")})
