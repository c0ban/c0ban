...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid c0ban address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        assert_equal(self.nodes[0].getbalance(), bal+Decimal('22000.00000000')+Decimal('2.19000000')) #block reward + tx
