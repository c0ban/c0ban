...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("jp01.dnsseed.c0ban.com", true); // Tokyo
        vSeeds.emplace_back("kr01.dnsseed.c0ban.com", true); // Souel
        ...
        chainTxData = ChainTxData{
            ...
            1512539390, // * UNIX timestamp of last known number of transactions
            971389,  // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.02769591118         // * estimated number of transactions per second after that timestamp
        };
    }
};
