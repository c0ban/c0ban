...
public:
    CMainParams() {
        ...
        consensus.CSVHeight =    9999999999; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5
        consensus.SegwitHeight = 9999999999; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 9999999999; // segwit activation height + miner confirmation window
        ...
        consensus.nMinimumChainWork = uint256S("0000000000000000000000000000000000000000000000b0808d17d194dd69a3");   // height 957752 chainwork
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000005184ffce04351e687a3965b300ee011d26b2089232cd039273be4a67"));
        ...
        vSeeds.emplace_back("jp01.dnsseed.c0ban.com"); // Tokyo
        vSeeds.emplace_back("kr01.dnsseed.c0ban.com"); // Soul
        ...
        chainTxData = ChainTxData{
            // Data as of block 0x0000000000000355017a157c1b0e6256754137f6428ba5dedb0bd3992b920b07 (height 957752).
            /* nTime    */ 1512539390,
            /* nTxCount */ 971389,
            /* dTxRate  */ 0.02769591118,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet01.dnsseed.c0ban.com", true);
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.SegwitHeight = 1050; // SEGWIT is always activated on regtest unless overridden
        consensus.MinBIP9WarningHeight = 1060;
        ...
        // Hardfork params
        nZawyLwmaAveragingWindow = 8;
        nSwitchLyra2REv2_LWMA = 1;
        nSwitchLyra2REvc0ban_LWMA = 1;
