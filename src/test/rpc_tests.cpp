...
BOOST_AUTO_TEST_CASE(rpc_convert_values_generatetoaddress)
{
    ...
    /* Modified by Qianren Zhang May 25th, 2017  */
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("101")("8ZvurVzgnirjAT7HvYwBXgSEyPwC1DmzAd")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);

    //BOOST_CHECK_EQUAL(result[1].get_str(), "mkESjLZW66TmHhiFX8MCaBjrhZ543PPh9a");
    BOOST_CHECK_EQUAL(result[1].get_str(), "8ZvurVzgnirjAT7HvYwBXgSEyPwC1DmzAd");
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("101")("8Ubx9iGZYtgrXowchT622xSdn8tUtaFPZc")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);

    //BOOST_CHECK_EQUAL(result[1].get_str(), "mhMbmE2tE9xzJYCV9aNC8jKWN31vtGrguU");
    BOOST_CHECK_EQUAL(result[1].get_str(), "8Ubx9iGZYtgrXowchT622xSdn8tUtaFPZc");
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("1")("8Ubx9iGZYtgrXowchT622xSdn8tUtaFPZc")("9")));BOOST_CHECK_EQUAL(result[0].get_int(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "8Ubx9iGZYtgrXowchT622xSdn8tUtaFPZc");
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("1")("8KZidxUnbBuKh3MBqFB1krEe1rbrKf7cPf")("9")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "8KZidxUnbBuKh3MBqFB1krEe1rbrKf7cPf");
    BOOST_CHECK_EQUAL(result[2].get_int(), 9);
}
