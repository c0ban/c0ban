...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 15 min) */
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_BASE = 1500000;
...
// TODO: set DEFAULT_CHECKPOINTS_ENABLED to false because it is necessary to adjust the parameter and test it
