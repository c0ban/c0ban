...
//static const bool DEFAULT_CHECKPOINTS_ENABLED = true; Modified by Qianren Zhang 	Oct. 17, 2016
...
/* static const signed int DEFAULT_CHECKBLOCKS = 6;   Modified by Qianren Zhang Dec. 7, 2016 */
