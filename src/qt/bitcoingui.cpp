...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a c0ban: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible c0ban command-line options").arg(PACKAGE_NAME));
