...
QT_TRANSLATE_NOOP("c0ban-core", "Cannot write to data directory '%s'; check permissions."),
QT_TRANSLATE_NOOP("c0ban-core", "Change index out of range"),
QT_TRANSLATE_NOOP("c0ban-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("c0ban-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("c0ban-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("c0ban-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("c0ban-core", "Could not parse asmap file %s"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Error loading %s: Private keys can only be disabled during creation"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("c0ban-core", "Error: Disk space is too low!"),
QT_TRANSLATE_NOOP("c0ban-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("c0ban-core", "Failed to rescan the wallet during initialization"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Invalid P2P permission: '%s'"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Prune mode is incompatible with -blockfilterindex."),
...
QT_TRANSLATE_NOOP("c0ban-core", "Section [%s] is not recognized."),
QT_TRANSLATE_NOOP("c0ban-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("c0ban-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("c0ban-core", "Specified -walletdir \"%s\" is a relative path"),
QT_TRANSLATE_NOOP("c0ban-core", "Specified -walletdir \"%s\" is not a directory"),
QT_TRANSLATE_NOOP("c0ban-core", "Specified blocks directory \"%s\" does not exist."),
QT_TRANSLATE_NOOP("c0ban-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("c0ban-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("c0ban-core", "The specified config file %s does not exist\n"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("c0ban-core", "Unable to generate initial keys"),
QT_TRANSLATE_NOOP("c0ban-core", "Unable to generate keys"),
QT_TRANSLATE_NOOP("c0ban-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("c0ban-core", "Unknown -blockfilterindex value %s."),
QT_TRANSLATE_NOOP("c0ban-core", "Unknown address type '%s'"),
QT_TRANSLATE_NOOP("c0ban-core", "Unknown change type '%s'"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Upgrading txindex database"),
