...
QT_TRANSLATE_NOOP("c0ban-core", "c0ban Core"),
QT_TRANSLATE_NOOP("c0ban-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Accept connections from outside (default: 1 if no -proxy or -connect)"),
QT_TRANSLATE_NOOP("c0ban-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("c0ban-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("c0ban-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("c0ban-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("c0ban-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("c0ban-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("c0ban-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("c0ban-core", "Block creation options:"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("c0ban-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("c0ban-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("c0ban-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("c0ban-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("c0ban-core", "Done loading"),
QT_TRANSLATE_NOOP("c0ban-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("c0ban-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("c0ban-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("c0ban-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("c0ban-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("c0ban-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("c0ban-core", "Error initializing wallet database environment %s!"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("c0ban-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("c0ban-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("c0ban-core", "Importing..."),
QT_TRANSLATE_NOOP("c0ban-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("c0ban-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("c0ban-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("c0ban-core", "Maintain at most <n> connections to peers (default: %u)"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("c0ban-core", "Options:"),
QT_TRANSLATE_NOOP("c0ban-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("c0ban-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("c0ban-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("c0ban-core", "Print version and exit"),
QT_TRANSLATE_NOOP("c0ban-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("c0ban-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("c0ban-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("c0ban-core", "RPC server options:"),
QT_TRANSLATE_NOOP("c0ban-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("c0ban-core", "Rebuild chain state from the currently indexed blocks"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("c0ban-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("c0ban-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("c0ban-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("c0ban-core", "Specify data directory"),
QT_TRANSLATE_NOOP("c0ban-core", "Specify pid file (default: %s)"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("c0ban-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("c0ban-core", "Unknown network specified in -onlynet: '%s'"),
...
QT_TRANSLATE_NOOP("c0ban-core", "Wallet options:"),
