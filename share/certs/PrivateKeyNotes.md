...
unlocked to sign the c0ban-Qt.app bundle.
...
allowing somebody to distribute a c0ban-Qt.app or c0ban-qt-setup.exe with a valid
...
that the c0ban-qt.exe file inside the installer had not been tampered with.
